    ...
    <div className="h-dvh snap-y snap-mandatory bg-orange-100 scroll-smooth w-full overflow-auto">
      ...
      <Screen>
        <div className="flex flex-col flex-1">
          ...
          <div className="px-12 flex-1 justify-evenly  flex flex-col ">
            <div className="border  border-gray-500 relative  flex items-center justify-evenly py-4 text-2xl">
              <div className="absolute top-[-25px] px-4 text-center bg-orange-100">
                Faltan
              </div>
